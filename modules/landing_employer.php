...
<body>
      ...
      <nav class="navbar navbar-expand-lg">
        <div class="container-fluid">
            ...
            <a class="nav-link" href="./login/login_emp.php">HOME</a>
            ...
            <button class="btn-link" type="button" onclick="selectOption('EMPLOYER', this)">Create Account</button>
            </div>
            <form id="registrationForm" method="POST" action="">
            <input type="hidden" id="selectedOption" name="selectedOption">
            </form>
            <a class="btn-link btn-signin" href="./login/login_emp.php">Sign In</a>
            </div>
        </div>
    </nav>
</header> 
...
<div class="main-content">
        <div class="text-content">
            <h1>Search your<br>Best Worker!</h1>
            <p>HanapKITA aims to revolutionize the worker search experience by providing an intuitive, efficient, and comprehensive platform for job seekers and employers alike.</p>
            <div class="search-bar">
                <input type="text" placeholder="Work title or Keyword">
                <select>
                ...
                <button onclick="window.location.href='./login/login_emp.php'">Find Now!</button>
            </div>
        </div>
        <div class="image-content">
            <img src="emp.png" alt="Job Search Image">
        </div>
    </div>
</div>
