     ...
     <header>
      <nav class="navbar navbar-expand-lg">
        <div class="container-fluid">
            ...
            <a class="nav-link" href="../landing_employer.php">HOME</a>
            <a class="nav-link" href="#top">JOB SEARCH</a>
            <a class="nav-link" href="#middle">WORKER</a>
            <a class="nav-link" href="#bottom">ABOUT</a>
            </div>
            <div class="nav-right">
            <a class="btn-link btn-signin" href="../landing_jobseeker.php" style="font-size: 15px;">Are you looking for a job?</a>
            </div>
        </div>
    </nav>
</header>
