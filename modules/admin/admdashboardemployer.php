                ...
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <a class="btn btn-light btn-sm me-2" href="admin-emp-signup.php">
                            <i class="bx bx-plus me-1"></i>Add New Employer
                        </a>
                        <button class="btn btn-light btn-sm" onclick="printEmployers()">
                            <i class="bx bx-printer me-1"></i>Print Employers List
                        </button>
                    </div>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="employersTable" class="table table-striped table-hover">
...
<script>
    ...
    function printEmployers() {
        ...
        let data = [];
        document.querySelectorAll('#employersTable tbody tr').forEach(row => {
            let rowData = [];
