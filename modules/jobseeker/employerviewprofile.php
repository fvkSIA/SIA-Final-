  ...
  <div class="container">
    <div class="profile-card">
      <div class="profile-container">
        <img src="../jobseeker/assets/images/sample-profile.png" alt="Profile Image" class="profile-image">
      ...
      <div class="info">
        <div><span class="label">Email:</span> <span class="value">john.doe@example.com</span></div>
        <div><span class="label">Gender:</span> <span class="value">Male</span></div>
        <div><span class="label">City:</span> <span class="value">Cityville</span></div>
        <div>
        </div>
      </div>
      ...
      <div class="valid-id-section">
        ...
        <iframe src="sample-valid-id.pdf" width="100%" height="600px" style="border: none;"></iframe>
      </div>

      <div class="action-buttons">
        <a href="jobseekerofferdetails.php?id=456" class="btn-hire" onclick="return confirm('Are you sure you want to view job details?');">Proceed</a>
