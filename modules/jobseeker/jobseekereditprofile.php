...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_FILES['profile_pic'])) {
        ...
        $targetDir = "../jobseeker/assets/images/";
...
<div class="container rounded bg-white mt-5 mb-5">
    <div class="row">
        <div class="col-md-3 border-right">
            <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                <div class="profile-pic">
                    ...
                    <form action="jobseekereditprofile.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="col-md-5 border-right">
            <div class="p-3 py-5">
                <form action="jobseekereditprofile.php" method="POST">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-12"><label class="labels">Type</label><input type="text" class="form-control" placeholder="enter type" value="<?php echo $data['user_type_desc'];?>" disabled></div>
